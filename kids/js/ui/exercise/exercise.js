...
var ExerciseUI = {
  ...
  icon: function(key){
    var icons = {
      ...
      zoom: '<svg width="40" height="40" viewBox="0 0 24 24" fill="none"><g stroke="#FF6B35" stroke-width="2.2" stroke-linecap="round"><path d="M2 8h12M2 12h16M2 16h9"/></g></svg>',
      ...
      skate: '<svg width="40" height="40" viewBox="0 0 24 24" fill="none"><rect x="6" y="8" width="9" height="6" rx="2" fill="#4FB8E0"/><path d="M4 14h13l3 3H4a2 2 0 0 1-2-2 1 1 0 0 1 2-1Z" fill="#3A1F5C"/><circle cx="7" cy="19" r="1.6" fill="#3A1F5C"/><circle cx="12" cy="19" r="1.6" fill="#3A1F5C"/><circle cx="17" cy="19" r="1.6" fill="#3A1F5C"/></svg>',
