...
var ExerciseUI = {
  ...
  icon: function(key){
    var icons = {
      ...
      // Three lines alone read as a hamburger menu, not "fast" — an
      // arrowhead turns it into an unambiguous motion/speed streak.
      zoom: '<svg width="40" height="40" viewBox="0 0 24 24" fill="none"><g stroke="#FF6B35" stroke-width="2.2" stroke-linecap="round"><path d="M2 9h9M2 13h13M2 17h7"/></g><path d="M20 13l-5-3.2v6.4Z" fill="#FF6B35"/></svg>',
